...
class Membership extends BaseModel
{
    ...
    protected $fillable = [
        #Add Attributes
        "member_type_id", "number_membership", "branch", "date_start", "date_end",
    ...
    public function validationRules()
    {
        return function (BaseRequest $validator) {
            ...
            return [
                ...
                "number_membership" => ['required', 'numeric', 'min:0', 'max:100000', Rule::unique('memberships', 'number_membership',)->ignore($memberID)],
